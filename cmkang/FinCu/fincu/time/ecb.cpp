#include <fincu/time/ecb.hpp>
//#include <fincu/settings.hpp>
...
namespace FinCu {
    ...
    Date ECB::date(const string& ecbCode,
        ...
        else FC_FAIL("not an ECB month (and it should have been)");
    ...
    string ECB::code(const Date& ecbDate) {
        ...
        switch(ecbDate.month()) {
          ...
          case December:
            ...
            break;
          default:
            FC_FAIL("not an ECB month (and it should have been)");
        }
