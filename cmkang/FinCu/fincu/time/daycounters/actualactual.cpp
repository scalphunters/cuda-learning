...
namespace FinCu {
    ...
    ActualActual::implementation(ActualActual::Convention c) {
        switch (c) {
          ...
          default:
            FC_FAIL("unknown act/act convention");
        }
    }
    ...
    Time ActualActual::ISMA_Impl::yearFraction(const Date& d1,
        ...
        FC_REQUIRE(refPeriodEnd > refPeriodStart && refPeriodEnd > d1,
        ...
        Integer months =
            Integer(0.5+12.0*(refPeriodEnd-refPeriodStart)/365.0);
        ...
        if (d2 <= refPeriodEnd) {
            ...
            if (d1 >= refPeriodStart) {
                ...
                return period*daysBetween(d1,d2) /
    ...
    Time ActualActual::ISDA_Impl::yearFraction(const Date& d1,
        ...
        Time dib1 = (Date::isLeap(y1) ? 366.0f : 365.0f),
             dib2 = (Date::isLeap(y2) ? 366.0f : 365.0f);
