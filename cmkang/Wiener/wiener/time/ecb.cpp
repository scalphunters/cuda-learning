#include <wiener/time/ecb.hpp>
//#include <wiener/settings.hpp>
...
namespace Wiener {
    ...
    Date ECB::date(const string& ecbCode,
        ...
        else WI_FAIL("not an ECB month (and it should have been)");
    ...
    string ECB::code(const Date& ecbDate) {
        ...
        switch(ecbDate.month()) {
          ...
          case December:
            ...
            break;
          default:
            WI_FAIL("not an ECB month (and it should have been)");
        }
